 ...
 */
public class TopTenAcessInventory extends Fragment {
    private ListView mlistView;
    CommonAdapterTopTen adapter;
    ArrayList<CommonTopTenModel> amCallPannerList;
    private String type;

    public TopTenAcessInventory() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.top_ten_parts, container, false);
            ...
            public void processResponse(Object response) {
                ...
                if (response == null) {
                    ...
                    if (response != null) {
                        ...
                        amCallPannerList = FetchingdataParser.getCommonTopTenPartResponce(response.toString());
...
// ByVal UserID As String, ByVal Password As String) As String
        ...
        try {
            ...
            if (passworddetails.getString(Constants.CONTACTTYPEID, "").equalsIgnoreCase("14")){
                request.put("ContactID",passworddetails.getString(Constants.DEALERID, ""));
            }else {
                request.put("ContactID",passworddetails.getString(Constants.USERID, ""));
            }
            request.put("MISType","ACESS INVENTORY");
            request.put("IsPartWIse","1");
