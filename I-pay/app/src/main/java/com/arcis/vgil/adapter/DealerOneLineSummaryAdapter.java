...
public class DealerOneLineSummaryAdapter extends
        ArrayAdapter<DealerOneLineSummaryModel> {

	private int resourceID;
	private LayoutInflater minflatitor;
	private ArrayList<DealerOneLineSummaryModel> dealerOneLineSummaryList = new ArrayList<DealerOneLineSummaryModel>();
	private Context context;
	private int pos=0;
	AlertDialog dialog;

	public DealerOneLineSummaryAdapter(Context context, int resource,
                                       ArrayList<DealerOneLineSummaryModel> dealerOneLineSummaryList) {
	...
	@Override
	public DealerOneLineSummaryModel getItem(int position) {
		// TODO Auto-generated method stub
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DealerOneLineSummaryModel details = dealerOneLineSummaryList
				.get(position);
		...
		if (convertView == null) {
			...
			holder.et_deale_code = (TextView) convertView
					.findViewById(R.id.et_deale_code);
			holder.et_deale_oneline_dealership_name = (TextView) convertView
					.findViewById(R.id.et_deale_oneline_dealership_name);
		...
		if (details.getAMName().equalsIgnoreCase("TOTAL")) {
			...
			holder.et_deale_code.setText("");
			holder.et_deale_oneline_dealership_name.setText(details
					.getDealerShipName());
			holder.city.setText(details.getDealerCity());
			...
			holder.et_deale_code.setText(details.getBusinessPartner());
			holder.et_deale_oneline_dealership_name.setText(details
					.getDealerShipName());
			holder.city.setText(details.getDealerCity());
			...
			holder.et_dealer_oneline_total_outstanding
					.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
						    ...
						    DealerOneLineSummaryModel details = dealerOneLineSummaryList
									.get(pos);    
							DealerOneLineSummaryDetail(details.getDealerID(),"TotalOutstanding");
						}
					});
			...
			holder.et_dealer_oneline_Current
					.setOnClickListener(new OnClickListener() {
						...
						// TODO Auto-generated method stub
						    ...
						    DealerOneLineSummaryModel details = dealerOneLineSummaryList
									.get(pos);    
							DealerOneLineSummaryDetail(details.getDealerID(),"Current");
			...
			holder.et_dealer_oneline_OD_UPTO_30
					.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
						    ...
						    DealerOneLineSummaryModel details = dealerOneLineSummaryList
									.get(pos);    
							DealerOneLineSummaryDetail(details.getDealerID(),"OD UPTO 30");
						}
					});
			...
			holder.et_dealer_oneline_OD_less_30
					.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
						    ...
						    DealerOneLineSummaryModel details = dealerOneLineSummaryList
									.get(pos);    
							DealerOneLineSummaryDetail(details.getDealerID(),"OD>30");
						}
					});
			holder.et_dealer_oneline_OD_less_60
					.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
						    ...
						    DealerOneLineSummaryModel details = dealerOneLineSummaryList
									.get(pos);    
							DealerOneLineSummaryDetail(details.getDealerID(),"OD>60");
	...
	protected void DealerOneLineSummaryDetail(String dealerID, String string) {
		// TODO Auto-generated method stub
		GetDataFromNetwork dataFromNetwork = new GetDataFromNetwork(context, ProgressDialog.STYLE_SPINNER,"Loading...", new GetDataCallBack() {
			@Override
			public void processResponse(Object response) {
				if(response!=null){
                      
					ArrayList<DealerOneLineSummaryModelDetails> dealerOneLineSummaryList = FetchingdataParser.getDealer_ONeLineSummayDetails(response.toString());
					if(dealerOneLineSummaryList!=null ){
						if (dealerOneLineSummaryList.size()!=0) {
						
							  //dealerOneLineSummaryAdapter=new DealerOneLineSummaryAdapter(context, R.layout.dealer_oneline_summary_shell, dealerOneLineSummaryList);
							 // listview_oneline_dealer.setAdapter(dealerOneLineSummaryAdapter);
							
							LayoutInflater inflator = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
							View view  = inflator.inflate(R.layout.dealer_oneline_summary_details, null);
							ListView listview_oneline_dealer_details=(ListView) view.findViewById(R.id.listview_oneline_dealer_details);
							TextView tittle_text=(TextView) view.findViewById(R.id.tittle_activity);
							tittle_text.setText("Details Screen");
				            AlertDialog.Builder  builder= new AlertDialog.Builder(context);
				            builder.setView(view);
				        
				              DealerOneLineSummaryDetailsAdapter  dealerOneLineSummaryAdapter=new DealerOneLineSummaryDetailsAdapter(context, R.layout.dealer_oneline_summary_details_shell, dealerOneLineSummaryList);
				              listview_oneline_dealer_details.setAdapter(dealerOneLineSummaryAdapter);
						...
						Toast.makeText(context,context.getResources().getString(R.string.message4)+"4" , Toast.LENGTH_SHORT).show();
		...
		SharedPreferences passworddetails=context.getSharedPreferences("PASSWORD", context.MODE_PRIVATE);



		try {
	
			//Function DealerOneLineSummaryDetail(ByVal ContactTypeID As String, ByVal ContactID As String,
			//ByVal DealerID As String, ByVal StatusType As String) As String
		...
		String methodName="DealerOneLineSummaryDetail";
	...
	static class ViewHolder {
		private TextView et_delaer_oneline_am_name, et_deale_code,
				et_deale_oneline_dealership_name, city,
