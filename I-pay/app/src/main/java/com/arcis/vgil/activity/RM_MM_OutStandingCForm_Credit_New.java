...
public class RM_MM_OutStandingCForm_Credit_New  extends BaseActivity{
		...
		ContactID =spref.getString(Constants.USERID, "");
		 ...
		 am_listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                                    long arg3) {
				// TODO Auto-generated method stub
					 Intent intent= new Intent(RM_MM_OutStandingCForm_Credit_New.this,RM_MM_OustandingDealerNameList.class);
				...
				if(response!=null){
					...
					if(arealist.size()==0){
						...
						if(geoName.equalsIgnoreCase(Constants.GEOCODE_AREA)){
							...
							adapter=new AmNameListAdapter(getCurrentContext(), R.layout.rm_mm_outsatanding_shell, amNameModelsList);
