...
public class GetDataFromNetworkCoupon  extends AsyncTask<Void, String, Object> {
	...
	private GetDataCallBackCoupon callBack;
	...
	public GetDataFromNetworkCoupon(Context context, int progressBarStyle, String message, String couponCode, int index, GetDataCallBackCoupon callBack) {
	...
	protected void onPostExecute(Object result) {
		...
		callBack.processResponse(result,couponCode,listitemindex);
