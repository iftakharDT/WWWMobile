 ...
 */
	public class DealerSale extends BaseActivity implements OnClickListener {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.dealersale);
			
			//	save,cancel ,additem,datebutton
		setCurrentContext(this);
		partyname=(EditText) findViewById(R.id.partyname);
		
		datetext=(EditText) findViewById(R.id.datetext);
		btn_submit = (Button)findViewById(R.id.submitdate);
		btn_submit.setOnClickListener(this);
		
		qty=(EditText) findViewById(R.id.quantity);
		mproductlist = (ListView)findViewById(android.R.id.list);
		...
		itemCode = (EditText)findViewById(R.id.edttxtitemcode);
		itemName = (EditText)findViewById(R.id.edttxtitemname);
		
		txt_stockQuantity = (TextView)findViewById(R.id.txtview_stockQuantity);
		txt_btsbtoclassification = (TextView)findViewById(R.id.txtview_btobtsclasific);
		txt_rygstatus = (TextView)findViewById(R.id.txtview_rygstatus);
		txt_amount = (TextView)findViewById(R.id.txtview_totalAmount);
		
		btn_red 	= (Button)findViewById(R.id.statusred);
		btn_yellow 	= (Button)findViewById(R.id.statusyellow);
		btn_green =(Button)findViewById(R.id.statusgreen);
		
		rg_saleType = (RadioGroup)findViewById(R.id.dealertype);
	...
	@Override
		public void onClick(View v) {
			switch (v.getId()) {
				case R.id.date:
					...
					DatePickerDialog datePickerDialog= new DatePickerDialog(DealerSale.this, new DatePickerDialog.OnDateSetListener() {
						@Override
						public void onDateSet(DatePicker view, int year, int month, int date) {
							...
							if(date>currDate || month>currmonth){
								Toast.makeText(view.getContext(), getStringFromResource(R.string.dateerror), Toast.LENGTH_LONG).show();
							}else{
			...
			case R.id.additem:
				...
				break;
			case R.id.cancel:
				startActivity(new Intent(DealerSale.this,ViewAll_AM.class));
				finish();
		...
		public boolean validation(){
			...
			if (qty.length() == 0 || Integer.parseInt(qty.getText().toString())> Integer.parseInt(txt_stockQuantity.getText().toString())) {
				qty.setError(getStringFromResource(R.string.quantity));
				flag = false;
			}
			
			if (!flag && !errMgs.equals(getStringFromResource(R.string.error2))) {
				Toast.makeText(DealerSale.this, errMgs, Toast.LENGTH_LONG)
						.show();
			}	
			return flag;
		...
		private void getProductList(){
			...
			GetDataFromNetwork datafromnetwork = new GetDataFromNetwork(DealerSale.this, ProgressDialog.STYLE_SPINNER, "Loading products...", new GetDataCallBack() {
					...
					if(result==null){
						...
						if(productList==null){
							...
							if(productList.size()==0){
								...
								SimpleAdapter dataadapter  = new SimpleAdapter(DealerSale.this, productList, android.R.layout.simple_list_item_1, new String[]{Constants.CODE}, new int[]{android.R.id.text1});
			...
			try {
				...
				requestdata.put(Constants.CONTACTID, passworddetails.getString("username",""));
		...
		private void getProductDetails( String productid){
			...
			GetDataFromNetwork datafromnetwork = new GetDataFromNetwork(DealerSale.this, ProgressDialog.STYLE_SPINNER, "Loading product details...", new GetDataCallBack() {
		...
		private void getAlreadySaleProductList(String date){
			...
			GetDataFromNetwork datafromnetwork = new GetDataFromNetwork(DealerSale.this, ProgressDialog.STYLE_SPINNER, getStringFromResource(R.string.loadsalelist), new GetDataCallBack() {
		...
		private void uploadData(ArrayList<ProductDetails> savedDataList){
			...
			RadioButton rb = (RadioButton)findViewById(R.id.radioBtbsale);
			...
			GetDataFromNetwork datafromnetwork = new GetDataFromNetwork(getCurrentContext(), ProgressDialog.STYLE_SPINNER, getStringFromResource(R.string.uploaddata), new GetDataCallBack() {
				...
				public void processResponse(Object result) {
					...
					if(result!=null && result.toString().length()==0){
						...
						AlertDialog.Builder errordialog = new AlertDialog.Builder(getCurrentContext());
						errordialog.setTitle("Error!");
						errordialog.setMessage(getStringFromResource(R.string.error6));
						errordialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
