 ...
 */
public class RM_MM_SalesAmTMAdapter extends ArrayAdapter<RM_MM_AMSalesModel> implements Filterable {
    ...
    public RM_MM_SalesAmTMAdapter(Context context, int resource,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            LinearLayout ll_shell= (LinearLayout) convertView.findViewById(R.id.ll_shell);
           // ll_shell.setWeightSum(2);
        ...
        if (details.getAMName().equalsIgnoreCase("TOTAL")){
            ...
            holder.textView2.setText(details.getTYValue());
            holder.dealer_details.setVisibility(View.GONE);
            holder.part_details.setVisibility(View.GONE);

        }else {
            holder.textView1.setText(details.getAMName());
            holder.textView2.setText(details.getTYValue());
            holder.dealer_details.setVisibility(View.VISIBLE);
            holder.part_details.setVisibility(View.VISIBLE);
        }
