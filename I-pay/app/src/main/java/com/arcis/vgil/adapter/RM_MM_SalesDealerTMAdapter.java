...
public class RM_MM_SalesDealerTMAdapter  extends ArrayAdapter<RM_MM_DealerSalesModel> implements Filterable {
    ...
    public RM_MM_SalesDealerTMAdapter(Context context, int resource,
