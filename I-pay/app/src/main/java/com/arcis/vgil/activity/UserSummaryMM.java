...
public class UserSummaryMM extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ContactTypeID.equalsIgnoreCase("5")) {
		//	Function LoginWiseContactHi`erarchy(ByVal ContactTypeID As String,
			// ByVal ContactID As String, ByVal RMID As String,
			// ByVal SIID As String, ByVal AMID As String, ByVal DealerID As String,
			// ByVal RequiredContactType As String) As String

					/*RequiredContactType='DLR'
					RequiredContactType='AM'
					RequiredContactType='SI'
					RequiredContactType='RM'*/

			LoginWiseContactHierarchy(ContactTypeID,ContactID,"0","0","0","0","RM");
			LoginWiseContactHierarchy(ContactTypeID,ContactID,"0","0","0","0","SI");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		notificationImage.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent= new Intent(UserSummaryMM.this, UserNotification.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (id) {
	case 1:
		Intent intent  = new Intent(UserSummaryMM.this,UserSummaryMM.class);
		intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		startActivity(intent);
		break;
	case 2:
		Intent intent1=new Intent(UserSummaryMM.this, LoginActivity.class);
