...
public class RM_MM_CustomerMaster_Fitment extends BaseActivity {
	...
	public void inti() {
		...
		super.inti();
		setContentView(R.layout.rm_mm_customermaster_fitment);
		setCurrentContext(this);
		tv_spinner_segment=(TextView) findViewById(R.id.tv_spinner_segment);
		tv_spinner_oe=(TextView) findViewById(R.id.tv_spinner_oe);
		tv_spinner_application=(TextView) findViewById(R.id.tv_spinner_application);
		...
		tv_spinner_application.setVisibility(View.GONE);
	       ...
	       et_avg_call_peryear=(EditText) findViewById(R.id.et_avg_call_peryear);
	       et_last_call_date=(EditText) findViewById(R.id.et_last_call_date);
	       et_cus_value_pm=(EditText) findViewById(R.id.et_cus_value_pm);
	       et_cus_value_tm=(EditText) findViewById(R.id.et_cus_value_tm);
				...
				TypespinnerList = FetchingdataParser.getAreaManagerContacts(response.toString());
					if(TypespinnerList!=null ){
						if (TypespinnerList.size()!=0) {
					       TypesegmentAdapter = new SimpleAdapter(getCurrentContext(), TypespinnerList, android.R.layout.simple_spinner_item, new String[]{Constants.NAME}, new int[]{android.R.id.text1});
				...
				if(response!=null){
					...
					if(partnoList!=null){
						if (partnoList.size()!=0) {
							...
							Toast.makeText(getCurrentContext(),"No Data", Toast.LENGTH_SHORT).show();
						}
...
//			Function ExternalContactMAsterCouponValue_MIS(ByVal CityID As String, 
		...
		//	ByVal UserID As String, ByVal Password As String) As String
			...
			Intent intent=new Intent(RM_MM_CustomerMaster_Fitment.this,AmCustomerMaster_FitmentDetails.class);
        ...
        partNoAdapter=new PartNoAllCustomAlertAdapter(getCurrentContext(), R.layout.am_manual_part_no_shell, partnoList);
            ...
            searchpartNo.addTextChangedListener(new TextWatcher() {
    			...
    			public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
    				...
    				if(RM_MM_CustomerMaster_Fitment.this.partNoAdapter!=null)
    					RM_MM_CustomerMaster_Fitment.this.partNoAdapter.getFilter().filter(arg0);
    			}
