...
public class AmSaleReport  extends BaseActivity{
	...
	*/
	...
	get=(Button) findViewById(id.get_value);
	get.setOnClickListener(this);
	from_date=(Button) findViewById(id.from_date);
	from_date.setOnClickListener(this);
	to_date=(Button) findViewById(id.to_date);
	to_date.setOnClickListener(this);
	from_date_edit=(EditText) findViewById(id.from_date_edit);
	to_date_edit=(EditText) findViewById(id.to_date_edit);
	ll_pending_order_click=(LinearLayout) findViewById(id.ll_pending_order_click);
	...
	countryspinner=(Spinner)findViewById(id.spinner_contry);
	part_no=(EditText) findViewById(id.part_no);
	...
	zonespinner=(Spinner)findViewById(id.spinner_zone);
	...
	statespinner=(Spinner)findViewById(id.spinner_state);
	...
	cityspinner=(Spinner)findViewById(id.spinner_city);
	...
	spnr_Am=(Spinner) findViewById(id.spinner_am);
	...
	spnr_dealer=(Spinner) findViewById(id.spinner_dealer);
	...
	spnr_segment = (Spinner)findViewById(id.spinner_segment);
	...
	spnr_oe = (Spinner)findViewById(id.spinner_oe);
	...
	spnr_appication = (Spinner)findViewById(id.spinner_application);
...
// Public Function GetAllProduct_MIS(SegmentID As Integer, OEID As Integer, ApplicationID As Integer, ByVal UserID As String, ByVal Password As String)
	...
	public void onClick(View v) {
		...
		case id.get_value:
           ...
           if (isValidateGet()) {
			...
			case id.ll_pending_order_click:
				...
				if(response!=null){
					...
					if(segmentList!=null){
						...
						if(segmentList.size()==0){
							...
							ListView list_part_no = (ListView)view.findViewById(id.list_part_no);
							LinearLayout ll_pending_order_dialogue=(LinearLayout) view.findViewById(id.ll_pending_order_dialogue);
				            ...
				            builder.setView(view);
					            ...
					            SimpleAdapter adapter  = new SimpleAdapter(getCurrentContext(), segmentList, R.layout.am_sale_pending_order_detail_dialog_shell,
										...
										new int[]{id.item_value, id.item_previous_quantity, id.item_previous_value, id.item_current_quantity, id.item_current_value});
			...
			public void processResponse(Object response) {
				if(response!=null){
					...
					if(segmentList!=null){
						...
						TextView pYSaleQuantity=(TextView) findViewById(id.psq1);
						TextView pYSaleValue=(TextView) findViewById(id.psv1);
						TextView cYSaleQuantity=(TextView) findViewById(id.csq1);
						TextView cYSaleValue=(TextView) findViewById(id.csv1);
						
						TextView pYSecondarySaleQuantity=(TextView) findViewById(id.pssq2);
						TextView pYSecondarySaleValue=(TextView) findViewById(id.pssv2);
						TextView cYSecondarySaleQuantity=(TextView) findViewById(id.cssq2);
						TextView cYSecondarySaleValue=(TextView) findViewById(id.cssv2);
						
						TextView pYFitmentQuantity=(TextView) findViewById(id.pfsq3);
						TextView pYFitmentValue=(TextView) findViewById(id.pfsv3);
						TextView cYFitmentQuantity=(TextView) findViewById(id.cfsq3);
						TextView cYFitmentValue=(TextView) findViewById(id.cfsv3);
						
						TextView pYPendingQuantity=(TextView) findViewById(id.ppoq4);
						TextView pYPendingValue=(TextView) findViewById(id.ppov4);
						TextView cYPendingQuantity=(TextView) findViewById(id.cpoq4);
						TextView cYPendingValue=(TextView) findViewById(id.cpov4);
	...
	private void getSerachPartDetails() {
		...
		EditText searchpartNo = (EditText)view.findViewById(id.et_search);
		ListView list_part_no = (ListView)view.findViewById(id.list_part_no);
        AlertDialog.Builder  builder= new AlertDialog.Builder(getCurrentContext());
        builder.setView(view);
        partNoAdapter=new PartNoAllCustomAlertAdapter(getCurrentContext(), R.layout.am_manual_part_no_shell, partnoList);
            ...
            list_part_no.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					// TODO Auto-generated method stub
					 ...
					 part_no.setText(partnoList.get(position).getCode());
            ...
            searchpartNo.addTextChangedListener(new TextWatcher() {
    			...
    			public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
    				...
    				if(AmSaleReport.this.partNoAdapter!=null)
    					AmSaleReport.this.partNoAdapter.getFilter().filter(arg0);
    			}
