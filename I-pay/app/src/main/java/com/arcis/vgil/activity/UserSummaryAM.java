...
public class UserSummaryAM extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ContactTypeID.equalsIgnoreCase("1")) {
			//ContactType="HO";
			LoginWiseContactHierarchy(ContactTypeID,ContactID,"0","0",ContactID,"0","DLR");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		notificationImage.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent= new Intent(UserSummaryAM.this, UserNotification.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (id) {
			case 1:
				Intent intent  = new Intent(UserSummaryAM.this,UserSummaryAM.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
				startActivity(intent);
				break;
			case 2:
				Intent intent1=new Intent(UserSummaryAM.this, LoginActivity.class);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			case R.id.next:
				startActivity(new Intent(v.getContext(),ViewAll_AM.class));
				break;

			case R.id.get_value:
				if (et_dealer_auto.getText().length()!=0){
					AM_Summary_MIS( ContactTypeID,ContactID,RMID,SIID,ContactID,DealerID);
				}else {
					AM_Summary_MIS( ContactTypeID,ContactID,RMID,SIID,ContactID,"0");
