...
import com.arcis.vgil.adapter.RM_MM_SalesDealerAdapter;
 ...
 */
public class DealerNameHistoryForSale extends BaseActivity{


    private EditText et_search;
    private ListView am_listview;
    private ArrayList<RM_MM_DealerSalesModel> rm_mm_amSalesModelsList;
    private RM_MM_SalesDealerAdapter rm_mm_salesDealerAdapter ;
    ...
    public void inti() {
        ...
        ll_sale_header= (LinearLayout) findViewById(R.id.ll_sale_header);
        ...
        GetDataFromNetwork dataFromNetwork = new GetDataFromNetwork(getCurrentContext(), ProgressDialog.STYLE_SPINNER,"Loading...", new GetDataCallBack() {
            ...
            public void processResponse(Object response) {
                if(response!=null){
                    ...
                    rm_mm_amSalesModelsList = FetchingdataParser.getDealerNameWithSalesDetails(response.toString());
                    if(rm_mm_amSalesModelsList!=null){

                        if (rm_mm_amSalesModelsList.size()!=0) {
                            rm_mm_salesDealerAdapter=new RM_MM_SalesDealerAdapter(getCurrentContext(), R.layout.rm_mm_sale_shell, rm_mm_amSalesModelsList);
                            rm_mm_salesDealerAdapter.setpartDetailsToListener(new RM_MM_SalesDealerAdapter.partDetailsToListenerPart() {
                                @Override
                            ...
                            et_search.addTextChangedListener(new TextWatcher() {
                                ...
                                public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
                                    ...
                                    if(DealerNameHistoryForSale.this.rm_mm_salesDealerAdapter!=null)
                                        DealerNameHistoryForSale.this.rm_mm_salesDealerAdapter.getFilter().filter(arg0);
                                }
                ...
                if(response!=null){
                    ...
                    if(rm_mm_partSalesModelsList!=null){
                        ...
                        if (rm_mm_partSalesModelsList.size()!=0) {
                            ...
                            rm_mm_salesPartAdapter=new RM_MM_SalesPartAdapter(getCurrentContext(), R.layout.external_customer_master_cell, rm_mm_partSalesModelsList);
                            ...
                            searchpartNo.addTextChangedListener(new TextWatcher() {
                                ...
                                public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
                                    ...
                                    if(DealerNameHistoryForSale.this.rm_mm_salesPartAdapter!=null)
                                        DealerNameHistoryForSale.this.rm_mm_salesPartAdapter.getFilter().filter(arg0);
                                }
