...
public class RM_MM_SalesPartAdapter extends ArrayAdapter<RM_MM_SalesPartModel> implements Filterable {
    ...
    public RM_MM_SalesPartAdapter(Context context, int resource,
