...
public class DealerMannualSaleAdapter extends ArrayAdapter<DealerDealerSale> implements Filterable {
	...
	public DealerMannualSaleAdapter(Context context, int resource,
...
public View getView(int position, View convertView, ViewGroup parent) {
	...
	if(convertView==null){
		...
		holder.mtxt1 = (TextView)convertView.findViewById(R.id.partno);
