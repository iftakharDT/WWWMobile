...
public class DealerManualOrderFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(mLayoutview==null){
			...
			mLayoutview = inflater.inflate(R.layout.dealer_manual_order, null);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mdealerspinner = (Spinner)getView().findViewById(R.id.spinner_dealername);
		...
		edttxt_itemcode = (AutoCompleteTextView)getView().findViewById(R.id.searchcode);
		...
		edttxt_itemName = (AutoCompleteTextView)getView().findViewById(R.id.searchname);
		edttxt_qntity   = (EditText)getView().findViewById(R.id.quantity);
		edttxt_mobNo    = (EditText)getView().findViewById(R.id.edttxt_mobileno);
		edttxt_city     = (EditText)getView().findViewById(R.id.edttxt_city);
		btn_additem    = (Button)getView().findViewById(R.id.additem);
		btn_additem.setOnClickListener(this);
		btn_placeOrder  = (Button)getView().findViewById(R.id.save);
		btn_placeOrder.setOnClickListener(this);
		btn_cancle = (Button)getView().findViewById(R.id.cancel);
		btn_cancle.setOnClickListener(this);
		mlistView = (ListView)getView().findViewById(android.R.id.list);
		mlistView.setOnTouchListener(listTouchListener);
		registerForContextMenu(mlistView);
		mshowdealer = (LinearLayout)getView().findViewById(R.id.showdealer);
		...
		txt_totalAmont = (TextView)getView().findViewById(R.id.txtview_totalAmount);
		txt_discount   = (TextView)getView().findViewById(R.id.txtview_discount);
		txt_netAmont   = (TextView)getView().findViewById(R.id.txtview_netamount);
