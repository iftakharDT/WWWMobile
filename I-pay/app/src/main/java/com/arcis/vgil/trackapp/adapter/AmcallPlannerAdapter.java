...
public class AmcallPlannerAdapter extends ArrayAdapter<AmCallPlanerModel>  {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.MobileNo = (TextView) convertView.findViewById(R.id.text2);
			holder.State = (TextView) convertView.findViewById(R.id.text3);
			
			holder.City = (TextView) convertView.findViewById(R.id.text4);
			holder.Area = (TextView) convertView.findViewById(R.id.text5);
	...
	//	holder.cb_callplan.setOnCheckedChangeListener(this);
		...
		holder.State.setText(details.getState());
